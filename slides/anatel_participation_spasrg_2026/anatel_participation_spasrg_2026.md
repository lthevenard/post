...
math: mathjax
title: Ideas, Issue Networks, and the Argumentative Structure of Brazilian Notice-and-Comment Rulemaking
description: Conference presentation opening
author: Lucas Thevenard
---
<style>
section {
...
/* Minor adjustments for this three-slide opening */
...
.research-question {
  ...
  font-weight: 700;
  line-height: 1.32;
  margin: 30px 34px 24px 34px;
}
.model-flow {
  display: grid;
  grid-template-rows: 64px 18px 64px 18px 64px 18px 64px 18px 64px;
  height: 392px;
...
<div class="research-question">Under what conditions can public participation improve regulatory outcomes by introducing new economic and technical reasons, and under what conditions does it become merely a <i>pro forma</i> exercise?</div>
...
<div class="model-flow">
  <div class="model-step"><div class="model-number">1</div><div><strong>Agency</strong> chooses if and how participation will occur</div></div>
  <div class="model-arrow model-hidden">↓</div>
  <div class="model-step model-hidden"><div class="model-number">2</div><div><strong>Affected actors</strong> decide if and how to participate</div></div>
  <div class="model-arrow model-hidden">↓</div>
  <div class="model-step model-hidden"><div class="model-number">3</div><div><strong>Comments</strong> showcase patterns of participation (coalitions, requests, arguments)</div></div>
  <div class="model-arrow model-hidden">↓</div>
  <div class="model-step model-hidden"><div class="model-number">4</div><div><strong>Agency</strong> decides on the regulatory proposal</div></div>
  <div class="model-arrow model-hidden">↓</div>
  <div class="model-step model-hidden"><div class="model-number">5</div><div><strong>Agency</strong> chooses how to respond</div></div>
</div>
...
<div class="model-flow">
  ...
  <div class="model-step"><div class="model-number">2</div><div><strong>Affected actors</strong> decide if and how to participate</div></div>
  <div class="model-arrow model-hidden">↓</div>
  <div class="model-step model-hidden"><div class="model-number">3</div><div><strong>Comments</strong> showcase patterns of participation (coalitions, requests, arguments)</div></div>
  <div class="model-arrow model-hidden">↓</div>
  <div class="model-step model-hidden"><div class="model-number">4</div><div><strong>Agency</strong> decides on the regulatory proposal</div></div>
...
<div class="model-flow">
  ...
  <div class="model-step"><div class="model-number">2</div><div><strong>Affected actors</strong> decide if and how to participate</div></div>
  <div class="model-arrow">↓</div>
  <div class="model-step"><div class="model-number">3</div><div><strong>Comments</strong> showcase patterns of participation (coalitions, requests, arguments)</div></div>
  <div class="model-arrow model-hidden">↓</div>
  <div class="model-step model-hidden"><div class="model-number">4</div><div><strong>Agency</strong> decides on the regulatory proposal</div></div>
  <div class="model-arrow model-hidden">↓</div>
  <div class="model-step model-hidden"><div class="model-number">5</div><div><strong>Agency</strong> chooses how to respond</div></div>
...
<div class="model-flow">
  ...
  <div class="model-step"><div class="model-number">3</div><div><strong>Comments</strong> showcase patterns of participation (coalitions, requests, arguments)</div></div>
  <div class="model-arrow">↓</div>
  <div class="model-step"><div class="model-number">4</div><div><strong>Agency</strong> decides on the regulatory proposal</div></div>
  <div class="model-arrow model-hidden">↓</div>
  <div class="model-step model-hidden"><div class="model-number">5</div><div><strong>Agency</strong> chooses how to respond</div></div>
</div>
...
<div class="model-flow">
  ...
  <div class="model-step"><div class="model-number">4</div><div><strong>Agency</strong> decides on the regulatory proposal</div></div>
  <div class="model-arrow">↓</div>
  <div class="model-step"><div class="model-number">5</div><div><strong>Agency</strong> chooses if and how it will respond</div></div>
</div>
...
<div class="chart-frame"><img src="figures/02_request_direction_by_dimension.png"></div>

---

<div class="chart-frame"><img src="figures/03_request_direction_patterns.png"></div>

---

<div class="chart-frame"><img src="figures/p_balance_heat_nonzero_nt.png"></div>

---

<div class="chart-frame"><img src="figures/08_response_by_request_direction.png"></div>
...
<div class="chart-frame"><img src="figures/04_argument_prevalence.png"></div>

---

<div class="chart-frame"><img src="figures/05_argument_breadth.png"></div>

---

<div class="chart-frame"><img src="figures/06_arguments_by_request_direction.png"></div>

---

<div class="chart-frame"><img src="figures/09_response_by_argument_type.png"></div>

---

<div class="chart-frame"><img src="figures/13_argument_evolution_faceted_fixed_y_side_by_side.png"></div>